...
//instance ibject dan memberikan pengaturan halaman PDF
...
while ($row = mysqli_fetch_array($mahasiswa)) {
    $pdf->Cell(20, 7, $row['nim'], 1, 0);
    $pdf->Cell(50, 7, $row['nama'], 1, 0);
    $pdf->Cell(25, 7, $row['jkel'], 1, 0);
    $pdf->Cell(50, 7, $row['alamat'], 1, 0);
    $pdf->Cell(30, 7, $row['tgllhr'], 1, 1);
}
